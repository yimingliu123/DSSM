...
from models.mask_transformer.transformer_mamba3D import Maskmamba, ResidualTransformer3D
from models.vq.model import RVQVAE

from options.eval_t2m.option_t2m_mixss_eval import EvalT2MOptions
...
def load_trans_model(model_opt, which_model):
    t2m_transformer = Maskmamba(code_dim=model_opt.code_dim,
                                      cond_mode='text',
...
def load_res_model(res_opt):
    ...
    res_transformer = ResidualTransformer3D(code_dim=vq_opt.code_dim,
                                            cond_mode='text',
...
# python eval_t2m_trans_res.py --res_name rtrans_name --dataset_name t2m --name t2m_nlayer8_nhead6_ld384_ff1024_cdp0.1_rvq6ns --gpu_id 1 --cond_scale 4 --time_steps 10 --ext evaluation
#python eval_t2m_trans_res.py --res_name mamba_rtrans_name --dataset_name t2m --name t2m_nlayer8_nhead6_ld384_ff1024_cdp0.1_rvq6ns --gpu_id 1 --cond_scale 4 --time_steps 10 --ext evaluation