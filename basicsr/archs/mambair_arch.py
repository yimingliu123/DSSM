...
class MambaIR(nn.Module):
    ...
    def __init__(self,
        ...
        self.upsampler = upsampler #pixel-shuffle
        self.mlp_ratio=mlp_ratio
    ...
    def forward_features(self, x):
        ...
        print("@@@@ patch embd")
        print(x.shape)  #8 2304 180
        x = self.pos_drop(x)

        for layer in self.layers:
            x = layer(x, x_size)
        print("$$$$$$$$$$final mamba") #8 2304 180
        print(x.shape)
...
class ResidualGroup(nn.Module):
    ...
    def forward(self, x, x_size):
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!Rs-Grope")
        print(x.shape)
        A=self.patch_embed(self.conv(self.patch_unembed(self.residual_group(x, x_size), x_size)))
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!A+x")
        print((A+x).size)
        return A + x
